...
bool VoxelDataMap::is_chunk_surrounded(Vector3i pos) const {
	// TODO If that check proves to be too expensive with all chunks we deal with, cache it in VoxelChunks
