...
public:
	...
	static uint8_t get_transition_mask(const VoxelLodTerrainUpdateData::State &state, Vector3i chunk_pos,
	...
	static void send_chunk_save_requests(VolumeID volume_id, Span<VoxelData::ChunkToSave> chunks_to_save,
